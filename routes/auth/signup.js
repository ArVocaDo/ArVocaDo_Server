...
router.post('/', async (req, res) => {
    ...
    const signupQuery = 'INSERT INTO user (id, password, salt, u_name) VALUES (?, ?, ?, ?)';
    ...
    if (selectIdResult[0] == null) {
        ...
        const signupResult = await db.queryParam_Arr(signupQuery, [req.body.id, hashedPw.toString('base64'), salt, req.body.name]);
